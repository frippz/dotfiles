...
def main():
    ...
    parser.add_argument('path', type=str, help='The path to the directory with files to organize.')
    parser.add_argument('--dry-run', action='store_true', help='If set, the script will only simulate the actions.')
